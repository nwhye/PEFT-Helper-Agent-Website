...
hyperparameter_cols = [
    "batch_size", "learning_rate", "prefix_length", "prefix_dropout",
    "layers_tuned", "prefix_hidden", "prefix_projection"
]
...
print("User hyperparameters included in input features: batch_size, learning_rate, prefix_length, prefix_dropout, layers_tuned, prefix_hidden, prefix_projection, target_modules")
